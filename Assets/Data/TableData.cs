...
#pragma warning disable 414
		...
		public partial class TBL_MOVE_CARD : BGEntity
		{
			...
			private static readonly TBL_SOUND.Factory _factory8_PFS = new TBL_SOUND.Factory();
		...
		public partial class TBL_GAME_SETTING : BGEntity
		{
			...
			public System.Single CardWaitTime
			{
				get
				{
					return _CardWaitTime[Index];
				}
				set
				{
					_CardWaitTime[Index] = value;
				}
			}
			private static BansheeGz.BGDatabase.BGFieldEntityName _ufle12jhs77_name;
			public static BansheeGz.BGDatabase.BGFieldEntityName _name
			...
			private static BansheeGz.BGDatabase.BGFieldFloat _ufle12jhs77_CardWaitTime;
			public static BansheeGz.BGDatabase.BGFieldFloat _CardWaitTime
			{
				get
				{
					if(_ufle12jhs77_CardWaitTime==null || _ufle12jhs77_CardWaitTime.IsDeleted) _ufle12jhs77_CardWaitTime=(BansheeGz.BGDatabase.BGFieldFloat) MetaDefault.GetField(new BGId(4679801770110703634,5436774654717639561));
					return _ufle12jhs77_CardWaitTime;
				}
			}
			private static readonly TBL_MOVE_CARD.Factory _factory0_PFS = new TBL_MOVE_CARD.Factory();
			private static readonly TBL_ATTACK_CARD.Factory _factory1_PFS = new TBL_ATTACK_CARD.Factory();
		...
		public partial class TBL_SOUND : BGEntity
		{
			...
			public class Factory : BGEntity.EntityFactory
			{
				public BGEntity NewEntity(BGMetaEntity meta)
				{
					return new TBL_SOUND(meta);
				}
				public BGEntity NewEntity(BGMetaEntity meta, BGId id)
				{
					return new TBL_SOUND(meta, id);
				}
			}
			private static BansheeGz.BGDatabase.BGMetaRow _metaDefault;
			public static BansheeGz.BGDatabase.BGMetaRow MetaDefault
			{
				get
				{
					if(_metaDefault==null || _metaDefault.IsDeleted) _metaDefault=BGRepo.I.GetMeta<BansheeGz.BGDatabase.BGMetaRow>(new BGId(5558000536296404508,3568274432664824725));
					return _metaDefault;
				}
			}
			public static BansheeGz.BGDatabase.BGRepoEvents Events
			...
			public static BansheeGz.BGDatabase.BGFieldEntityName _name
			{
				get
				{
					if(_ufle12jhs77_name==null || _ufle12jhs77_name.IsDeleted) _ufle12jhs77_name=(BansheeGz.BGDatabase.BGFieldEntityName) MetaDefault.GetField(new BGId(5156693011717848303,6139868721865214379));
					return _ufle12jhs77_name;
				}
			}
			private static BansheeGz.BGDatabase.BGFieldUnityAudioClip _ufle12jhs77_Sound;
			public static BansheeGz.BGDatabase.BGFieldUnityAudioClip _Sound
			{
				get
				{
					if(_ufle12jhs77_Sound==null || _ufle12jhs77_Sound.IsDeleted) _ufle12jhs77_Sound=(BansheeGz.BGDatabase.BGFieldUnityAudioClip) MetaDefault.GetField(new BGId(4960717127400132927,15389343805321958563));
					return _ufle12jhs77_Sound;
				}
			}
			private static BansheeGz.BGDatabase.BGFieldString _ufle12jhs77_Comment;
			public static BansheeGz.BGDatabase.BGFieldString _Comment
			{
				get
				{
					if(_ufle12jhs77_Comment==null || _ufle12jhs77_Comment.IsDeleted) _ufle12jhs77_Comment=(BansheeGz.BGDatabase.BGFieldString) MetaDefault.GetField(new BGId(5574021906827125949,2610015853899505799));
					return _ufle12jhs77_Comment;
				}
			}
			private static readonly TBL_MOVE_CARD.Factory _factory0_PFS = new TBL_MOVE_CARD.Factory();
			...
			private static readonly TBL_GAME_SETTING.Factory _factory7_PFS = new TBL_GAME_SETTING.Factory();
			private static readonly TBL_SOUND.Factory _factory8_PFS = new TBL_SOUND.Factory();
			public TBL_SOUND() : base(MetaDefault)
			{
			}
			public TBL_SOUND(BGId id) : base(MetaDefault, id)
			{
			}
			public TBL_SOUND(BGMetaEntity meta) : base(meta)
			{
			}
			public TBL_SOUND(BGMetaEntity meta, BGId id) : base(meta, id)
			{
			}
			public static TBL_SOUND FindEntity(Predicate<TBL_SOUND> filter)
			{
				return MetaDefault.FindEntity(entity => filter==null || filter((TBL_SOUND) entity)) as TBL_SOUND;
			}
			public static List<TBL_SOUND> FindEntities(Predicate<TBL_SOUND> filter, List<TBL_SOUND> result=null, Comparison<TBL_SOUND> sort=null)
			{
				result = result ?? new List<TBL_SOUND>();
				_find_Entities_Result.Clear();
				MetaDefault.FindEntities(filter == null ? (Predicate<BGEntity>) null: e => filter((TBL_SOUND) e), _find_Entities_Result, sort == null ? (Comparison<BGEntity>) null : (e1, e2) => sort((TBL_SOUND) e1, (TBL_SOUND) e2));
				if (_find_Entities_Result.Count != 0)
				{
					for (var i = 0; i < _find_Entities_Result.Count; i++) result.Add((TBL_SOUND) _find_Entities_Result[i]);
					_find_Entities_Result.Clear();
				}
				return result;
			}
			public static void ForEachEntity(Action<TBL_SOUND> action, Predicate<TBL_SOUND> filter=null, Comparison<TBL_SOUND> sort=null)
			{
				MetaDefault.ForEachEntity(entity => action((TBL_SOUND) entity), filter == null ? null : (Predicate<BGEntity>) (entity => filter((TBL_SOUND) entity)), sort==null?(Comparison<BGEntity>) null:(e1,e2) => sort((TBL_SOUND)e1,(TBL_SOUND)e2));
			}
			public static TBL_SOUND GetEntity(BGId entityId)
			{
				return (TBL_SOUND) MetaDefault.GetEntity(entityId);
			}
			public static TBL_SOUND GetEntity(int index)
			{
				return (TBL_SOUND) MetaDefault[index];
			}
			public static TBL_SOUND GetEntity(string entityName)
			{
				return (TBL_SOUND) MetaDefault.GetEntity(entityName);
			}
			public static TBL_SOUND NewEntity()
			{
				return (TBL_SOUND) MetaDefault.NewEntity();
			}
		}
